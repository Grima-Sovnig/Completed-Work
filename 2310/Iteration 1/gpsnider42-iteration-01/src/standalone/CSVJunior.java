...
public class CSVJunior implements Generator {
    ...
    public boolean nextEvents()
    {
        ...
        while(scan.hasNextLine())
        {
            ...
            srcNode = data.getSrcIP();
            dstNode = data.getDstIP();
            if(!this.idCheck(srcNode) || !this.idCheck(dstNode))
            {
    ...
    {
        return (id.contentEquals("") || id.contentEquals("ip.dst") || id.contentEquals("ip.src") || id.contentEquals("255.255.255.255") || id.contentEquals("0.0.0.0") || id.contentEquals("srcIP") ||id.contentEquals("dstIP"));
    }
