...
int main()
{
	...
	cout << "\n\nThe number of characters in the string in the first node is " <<usefulStuff.front().length() << endl;  //prints out Sharpies
	cout << usefulStuff.back() << endl; //prints out Magic Erasers
